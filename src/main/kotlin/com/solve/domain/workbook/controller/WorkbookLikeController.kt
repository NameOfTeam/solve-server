...
class WorkbookLikeController(
    ...
    @PostMapping
    fun addWorkbookLike(@PathVariable workbookId: Long) = BaseResponse.of(workbookLikeService.addWorkbookLike(workbookId), 201)

    @Operation(summary = "문제집 좋아요 삭제")
    @DeleteMapping
    fun deleteWorkbookLike(@PathVariable workbookId: Long) = BaseResponse.of(workbookLikeService.removeWorkbookLike(workbookId), 204)
}