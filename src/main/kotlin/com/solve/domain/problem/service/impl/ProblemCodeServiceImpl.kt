...
class ProblemCodeServiceImpl(
    ...
    override fun updateCode(problemCodeId: Long, request: ProblemCodeUpdateRequest): ProblemCodeResponse {
        val code =
            problemCodeRepository.findByIdOrNull(problemCodeId) ?: throw CustomException(ProblemCodeError.PROBLEM_CODE_NOT_FOUND)
    ...
    override fun deleteCode(problemCodeId: Long): ProblemCodeResponse {
        val code = problemCodeRepository.findByIdOrNull(problemCodeId) ?: throw CustomException(ProblemCodeError.PROBLEM_CODE_NOT_FOUND)
    ...
    override fun getCode(problemCodeId: Long): ProblemCodeResponse {
        val code = problemCodeRepository.findByIdOrNull(problemCodeId) ?: throw CustomException(ProblemCodeError.PROBLEM_CODE_NOT_FOUND)
